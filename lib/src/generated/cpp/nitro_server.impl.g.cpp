// Generated by Nitrogen — edit this file to implement NitroServer.
//
// This file is a one-time starter: Nitrogen will NOT overwrite it.
// Rename it to e.g. "NitroServerImpl.cpp" and add it to CMakeLists.txt.
//
// Quick-start:
...
class NitroServerImpl final : public HybridNitroServer {
public:
    NitroServerImpl() = default;
    ~NitroServerImpl() override = default;
...
//
//   void NitroServerPlugin::RegisterWithRegistrar(PluginRegistrar* registrar) {
//       static NitroServerImpl impl;
