...
public struct RawServerConfig: NitroEncodable {
  ...
  public init(host: String, port: Int64, backlog: Int64, maxBodyBytes: Int64, defaultTimeoutMs: Int64, keepAliveTimeoutMs: Int64, maxRequestsPerConn: Int64, workerThreads: Int64, maxConnections: Int64, maxConnectionsPerIp: Int64, headerTimeoutMs: Int64, tls: RawTlsConfig) {
    self.host = host
    self.port = port
...
public struct RawRouteConfig: NitroEncodable {
  ...
  public init(method: RawServerMethod, customMethod: String, pattern: String, timeoutMs: Int64, isWebSocket: Bool, streamBody: Bool) {
    self.method = method
