...
/**
 * Protocol for the NitroServer module.
 ...
 */
public protocol HybridNitroServerProtocol: AnyObject {
...
public class NitroServerRegistry {
    public static var impl: HybridNitroServerProtocol?

    public static func register(_ impl: HybridNitroServerProtocol) {
        NitroServerRegistry.impl = impl
    }
}
...
// source: nitro_server.native.dart:9
@_cdecl("_nitro_server_call_add")
public func _nitro_server_call_add(_ a: Double, _ b: Double) -> Double {
    guard let impl = NitroServerRegistry.impl else { return 0.0 }
    return impl.add(a: a, b: b)
}

// source: nitro_server.native.dart:12
@_cdecl("_nitro_server_call_getGreeting")
public func _nitro_server_call_getGreeting(_ name: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>? {
    let nameStr = _nitroStringFromCString(name)
    guard let impl = NitroServerRegistry.impl else { return _nitroStringToCString("") }
